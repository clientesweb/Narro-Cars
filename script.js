...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const serviceDetails = {
        wash: {
            ...
            description: "Nuestro servicio de Lavado Premium está diseñado para dar a tu vehículo un acabado de calidad de exhibición.",
            features: [
        ...
        interior: {
            ...
            description: "Nuestro servicio de Limpieza de Interior limpia profundamente y refresca el interior de tu vehículo.",
            features: [
                "Aspirado minucioso",
        ...
        paint: {
            title: "Pulido",
            description: "Nuestro servicio de Pulido elimina imperfecciones y restaura la pintura de tu vehículo a su gloria original.",
            features: [
        ...
        ceramic: {
            ...
            description: "Nuestro servicio de Ceramic Coating proporciona una protección duradera y un brillo inigualable para tu vehículo.",
            features: [
